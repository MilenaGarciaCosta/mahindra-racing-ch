...
const Garrafa = () => {
  ...
  const itemCost = 150; // Custo da garrafa
  ...
  const handleResgatar = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/api/usuario/resgatar', {
        usuarioId,
        itemCost,
        itemName: 'Garrafa Mahindra Racing',
      });
        ...
        <div className="flex-main">
          ...
          <div className="flex-produto">
            ...
            <div className="descricaoProduto">
              <h2>Garrafa Mahindra Racing</h2>

              <p className="textoDescricao">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quia dicta necessitatibus assumenda autem natus, asperiores nam est exercitationem. Exercitationem modi nesciunt assumenda explicabo provident est nisi suscipit quibusdam aspernatur vel!
              </p>
